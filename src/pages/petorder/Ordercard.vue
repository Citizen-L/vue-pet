    ...
    <div class='ordercard' :style="border(statu)">
        ...
        <div class="message">
            ...
            <div class="but">
                ...
                <!-- 完成 -->
                <el-popover v-if="statu === 0" placement="top" width="160" v-model="showcomplete">
                    <p>已收到货，订单完成</p>
                ...
                <!-- 取消订单 -->
                <el-popover v-if="statu === 0" placement="top" width="160" v-model="cancelorder">
                    <p>确定要取消订单吗？</p>
                    <div style="text-align: right; margin: 0">
                ...
                <!-- 删除 -->
                <el-popover v-if="statu === 1 || statu === 2" placement="top" width="160" v-model="visible">
                    <p>删除后将无法恢复，确定删除吗？</p>
                    <div style="text-align: right; margin: 0">
        ...
        <div v-if="change === true">
            <div class="changepetorder" @click="closechange"></div>
...
<script>
    ...
    // import {requestupdatePet} from "@/api/index.js"
    import {requestupdatepetorder1,requestupdatepetorder2,requestdeletepetorder} from "@/api/order.js"
    ...
    export default {
        ...
        methods: {
            ...
            successupdate(form) {        //处理订单信息的更新成功事件,更新完拿给purchase组件
