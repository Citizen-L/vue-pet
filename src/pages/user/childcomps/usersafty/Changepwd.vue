    ...
    <div class='changepwd'>
        ...
        <!-- 旧密码 -->
            <div class="inp">
                ...
                <input :type="types[0].type" placeholder="旧密码"  @blur="checkoldpassword" v-model="form.oldpassword" :class="{ redborder: check.oldpassword.flag }"/>
        ...
        <!-- 新密码 -->
            <div class="inp">
                <img src="../../../../assets/img/password/password.png" alt class="img-bg" />
                <input :type="types[1].type" placeholder="新密码" @blur="checkPassword" v-model="form.password" :class="{ redborder: check.password.flag }"/>
        ...
        <!-- 确认密码 -->
            <div class="inp">
                <img src="../../../../assets/img/password/password.png" alt class="img-bg" />
                <input :type="types[2].type" placeholder="再次输入新密码" v-model="form.secondpassword" @blur="checksecondpassword" :class="{ redborder: check.secondpassword.flag }"/>
...
<script>
    import {requestchangepassword} from '@/api/user.js'
