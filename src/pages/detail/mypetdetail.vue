    ...
    <div class="mypetdetail">
        <div>
            ...
            <el-table :data="tableData" style="width: 100%">
                <el-table-column prop="uid" label="下单用户id" width="110">
                </el-table-column>
                ...
                <el-table-column prop="price" width="100" label="下单时价格">
                </el-table-column>

                <el-table-column prop="date" width="160" label="下单时间">
                </el-table-column>
                <!-- <el-table-column v-if="showorderchat" width="110" label="联系下单用户">
                    <template>
            ...
            <div v-if="shownew">
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="newrecipientname" label="收件人" width="110">
                    </el-table-column>

                    <el-table-column prop="newphone" label="手机号" width="120">
                    </el-table-column>

                    <el-table-column prop="newaddress" label="详细地址">
                    </el-table-column>
                    ...
                    <!-- <el-table-column width="110" label="联系下单用户">
                        <template>
                            <div class="chat" @click="tochat">
                                <img src="../../assets/img/chat/petorderchat.png" alt="" />
                            </div>
...
<script>
import { requestquerypetorder2,requestupdatepetorder2,requestupdatepetorder3} from '@/api/order'
/* import { requestaddContact } from '@/api/contact' */
...
export default {
    ...
    created(){
        requestquerypetorder2({
            ...
            this.tableData = res.fliter((n) => {
                return n.postatu != 2
            })
            if(
                this.tableData[0].newphone != null && this.tableData[0].newphone != "" &&  this.tableData[0].uid != this.$store.state.uid
            ){
                this.shownew = true
            }
            ...
            if (
                this.tableData[0].postatu == 4 && this.tableData[0].uid != this.$store.state.uid
            ) {
